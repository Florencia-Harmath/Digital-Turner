...
export const getUserById = async (req: Request, res: Response) => {
 ...
 export const registerUser = async (req: Request, res: Response) => {
     const { id, name, email, birthdate, nDni, username, password, role } = req.body;
     try {
         const newUser = await registerUserService({id, name, email, birthdate, nDni, username, password, role});
